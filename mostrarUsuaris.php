...
<html>
    <head>
	    ...
	    <title>Visualització d'usuaris</title>	
    </head>
    <body>
        ...
        <h1>Visualització d'usuaris</h1>
        <table border=1>
			<tr>
				<th>Nom complert</th><th>Adreça</th><th>Correu</th><th>Telèfon</th><th>Identificador personal</th><th>Contrasenya</th><th>Llibre en préstec</th><th>Data préstec</th><th>ISBN préstec</th>
			</tr>
			<?php
				$filename="usuaris";
